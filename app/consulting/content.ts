...
export const consultingDetails: Record<ConsultingSlug, ConsultingDetail> = {
    ...
    "infrastructure-services": {
        ...
        subtitle: "Reliable, scalable, and operationally sound infrastructure for GCC enterprise workloads.",
    ...
    "security-governance": {
        ...
        sections: [
            ...
            },
            {
                ...
                bullets: ["GCC data sovereignty and residency aligned", "ISO 27001 and SOC2 readiness", "24/7 security operations and evidence trails"]
            }
        ],
        steps: [
